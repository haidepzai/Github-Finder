...
const User = () => {
    //user = User Object von Github mit props wie name, login etc.
    ...
    useEffect(() => {
        ...
        const getUserData = async() => {
            const userData = await getUserAndRepos(params.login) //HTTP Call
            dispatch({type: 'GET_USER_AND_REPOS', payload: userData}) //befüllt dann den State
        }

        getUserData()
    }, [dispatch, params.login]) 
    //Dependency, d.h. immer wenn es eine Veränderung bei dispatch und params.login gab, wird useEffect getriggert
    ...
    //Wenn man hier getUser als Dependency angibt -> Infinite Loop
    //da getUser aufgerufen wird und es eine Veränderung gibt -> Erneutes Triggern
    //getUser verändert State (Reducer) und führt zum Re-Render und somit zum erneuten Triggern von useEffect
